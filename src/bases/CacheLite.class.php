...
/**
 * include exception classs 
 *
 * modify by IceSNS at 2008-7-16 22:06
 */
...
define('CACHE_MODULE_NAME', 'Cache_Lite');


class CacheLite extends ExceptionClass
{
    ...
    */
    ...
    {
        if (!@unlink($file)) {
            return $this->raiseError( CACHE_MODULE_NAME. ' : Unable to remove cache !', -3);
        }
        return true;        
    }
    ...
    */
    function _cleanDir($dir, $group = false, $mode = 'ingroup')     
    {
        ...
        if (!($dh = opendir($dir))) {
            return $this->raiseError( CACHE_MODULE_NAME .' : Unable to open cache directory !', -4);
        }
        $result = true;
    ...
    */
    function _read()
    {
        ...
        return $this->raiseError( CACHE_MODULE_NAME .' : Unable to read cache !', -2); 
    }
    ...
    */
    function _write($data)
    {
        ...
        return $this->raiseError( CACHE_MODULE_NAME .' : Unable to write cache file : '.$this->_file, -1);
    }
    ...
    */
    function _hash($data, $controlType)
    {
        ...
        default:
            return $this->raiseError( CACHE_MODULE_NAME .' : Unknown controlType ! (available values are only \'md5\', \'crc32\', \'strlen\')', -5);
        }
    }
